        ...
        <section className="w-full ">
            <div className="w-full flex flex-col-reverse lg:flex-row gap-11 fp max-container">
                ...
                <div ref={containerRef} className="w-full lg:w-1/2 h-[120px] mmd:h-[140px] mlg:h-[160px] md:h-[200px] lg:h-auto relative ">
                    ...
                    {/* Bard AI */}
                    <Image className="float-icon absolute -top-5 left-25 sm:left-45 md:top-5 lg:top-30 lg:left-5  xxl:top-60 xxl:left-0 w-[20%] mlg:w-[16%] sm:w-[15%] lg:w-[27%] xl:w-[25%] " src="/icons/ai/bard-text.svg" alt="Bard AI" width={362} height={127} />
                    {/* ChatGPT AI */}
                    <Image className=" float-icon absolute -top-2 right-0 lg:top-30  xxl:top-50 xxl:right-10 w-[20%] mlg:w-[17%] sm:w-[15%] md:w-[13%] lg:w-[27%] xl:w-[24%] " src="/icons/ai/chatgpt.svg" alt="ChatGPT AI" width={512} height={509} />
                    {/* Copilot AI */}
                    <Image className="float-icon absolute bottom-13 left-5 mmd:bottom-15 mlg:bottom-18 lg:bottom-80 xl:bottom-65  xxl:bottom-60 xxl:left-15 w-[27%] mlg:w-[23%] sm:w-[18%] lg:w-[42%] xl:w-[40%] xxl:w-[42%] " src="/icons/ai/copilot-text.svg" alt="Copilot AI" width={229} height={64} />
                    {/* Gamma AI */}
