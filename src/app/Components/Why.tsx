    ...
    return (
        <section className="w-full  bg-white">
            <div className="w-full flex flex-col gap-10 xl:gap-18 fp items-center max-container">
                ...
                <div className="w-full grid grid-cols-1 grid-rows-6 sm:grid-cols-2 sm:grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 gap-6 xl:gap-10 xxl:gap-15 text-center">
                    {whyData.map((item, index) => (
                        <div className="relative">
                            <div className="absolute inset-0 z-0 primary blur-3xl opacity-50"></div>
                            <div className="relative h-full z-1 flex flex-col items-center gap-3 md:gap-7  bg-white rounded-[15px] p-5 md:p-8   ">
